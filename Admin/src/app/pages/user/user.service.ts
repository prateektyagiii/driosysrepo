...
import { SortDirection } from '../tables/advancedtable/advanced-sortable.directive';
...
function matches(tables: Table, term: string, pipe:PipeTransform) {
    return  tables.Firstname.toLowerCase().includes(term)
        // || tables.StreetAddress1.toLowerCase().includes(term)
        // || tables.StreetAddress2.toLowerCase().includes(term)
...
export class UserService{
    ...
    constructor(private pipe: DecimalPipe,private apicallService:ApicallService) {
